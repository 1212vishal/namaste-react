  ...
  return (
     <div className="header">
      ...
      <div className="Logo-cointainer">
        <img 
        className="logo" 
        src="https://image.freepik.com/free-vector/food-delivery-logo-with-bike-man-courier_1308-48914.jpg" 
        alt="not upload"
         />
      </div>
  ...
  return(
      <div className="body">
        ...
        <div className="res-container">
              {
                resList.map((resturant)=>(<RestaurantCard key={resData.data.id} resData={resturant}/>))
              } 
        </div>
